...
class Student:
	def __init__(self, student_dict):
		...
		self.age = set_field_if_exists('Age range', student_dict)
		self.chaperone_email = set_field_if_exists('Chaperone email', student_dict)
	...
	def to_row(self):
		...
		None, self.age, self.mainer, None, None, None, None, None, self.volunteer,
		...
		self.housing, self.roommate, self.room_waitlist, self.housing_needs, None, None,
